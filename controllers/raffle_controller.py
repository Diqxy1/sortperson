...
path_file_participant = path_connection + '/files/participants.txt'
...
def random_participant():
    with open(path_file_participant, 'r') as file:
    ...
    return "Não há participantes a serem sorteados. tente zerar a lista de sorteados"
